...
for a in range(1,100):    
    ...
    # Display the map
    m1.save("C:\\Venky\\invasive_species_detection\\drone_path\\drone_path_Bear_Branch.html")
    m2.save("C:\\Venky\\invasive_species_detection\\drone_path\\drone_path_Bear_Branch_orig.html")